...
declare global {
  ...
  export type SupraAccount = SupraAccount;
  export const SupraAccount: typeof SupraAccount;
  export type SupraClient = SupraClient;
  export const SupraClient: typeof SupraClient;
  export type BCS = BCS;
  export const BCS: typeof BCS;
  export type HexString = HexString;
  export const HexString: typeof HexString;
